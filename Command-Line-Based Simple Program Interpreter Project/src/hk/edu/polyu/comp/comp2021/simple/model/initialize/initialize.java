...
public abstract class initialize
{
     ...
     */
    static String[] unNameSet = {"null","int","bool","true","false","vardef", "binexpr", "unexpr", "assign", "print", "skip", "block", "if", "while", "program", "execute", "list", "store", "load", "quit", "debug", "togglebreakpoint", "inspect", "instrument"};
    /**
     * The Memory stored all the commands
     */
    public static HashMap<String, data> Memory = new HashMap<>();
     ...
     * @return true/false
     */
    public abstract boolean error(String[] s);

    /**
     * define command
     * @param s : command
     */
    public abstract void define(String[] s);
